...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Header cho mobile: Hamburger + Tiêu đề */}
      <div className="md:hidden fixed top-0 left-0 w-full z-50 bg-gray-200 dark:bg-gray-900 flex items-center justify-between px-4 h-16 border-b border-gray-300 dark:border-gray-800">
        <button
          className="p-2 rounded focus:outline-none bg-gray-200 dark:bg-gray-900 text-gray-900 dark:text-white"
        ...
        <div className="flex-1 flex justify-center">
          <h1 className="text-lg font-bold text-gray-900 dark:text-white">SmartWarehouse</h1>
        </div>
        <div className="w-9" /> {/* Để cân đối layout */}
      </div>
      ...
      {/* Sidebar: chỉ hiện trên mobile khi mobileOpen, luôn hiện trên desktop */}
      <div
        className={`
          fixed top-0 left-0 z-50 h-screen w-64 bg-gray-200 text-gray-900 dark:bg-gray-900 dark:text-white transition-transform duration-300 flex flex-col
          ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}
          md:static md:translate-x-0 md:flex md:flex-col
        `}
        style={{ maxWidth: '100vw' }}
      >
        {/* Logo/tiêu đề sidebar: chỉ hiện trên desktop */}
