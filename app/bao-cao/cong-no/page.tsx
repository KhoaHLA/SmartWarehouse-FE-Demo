    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Báo cáo công nợ</h1>
            <p className="text-gray-600 dark:text-gray-400">Theo dõi công nợ phải thu và phải trả</p>
          </div>
        </div>
